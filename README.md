...
## Dependencies:
+ Python 3.7.3+
+ PyTorch 1.6.0+ (for native mixed precision support)
+ torchvision 0.6.1+
+ ml_collections
...
To train TransFG on CUB-200-2011 dataset in FP-16 mode for 10000 steps run:

```bash
python3 train.py --dataset CUB_200_2011 --split overlap --num_steps 10000 --fp16 --name sample_run
```
